...
WHEEL_RADIUS = 1 # THE POINT OF THIS SCRIPT IS TO CALIBRATE THIS VALUE. NEED TO COMPARE ACTUAL DISTANCE TO ESTIMATED DISTANCE AND ADAPT WHEEL_RADIUS
...
X_GOAL = 1 # Place holder values
Y_GOAL = 0 # Place holder values
